...
// configuration step. It creates a namespace called `alb`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", alb::cmake::project_name, alb::cmake::project_version) };
